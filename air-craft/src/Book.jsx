                ...
                <div className="book-part">
                    ...
                    <form >
                        ...
                        <div className="row ">
                            <div className="col-md-6">
                                <input type="text" className="b-Input w-100" placeholder="First Name " />
                            </div>
                            <div className="col-md-6">
                                <input type="text" className="b-Input w-100" placeholder="Last Name " />
                            </div>
                        </div>
                        ...
                        <div className="edit-margin">
                            ...
                            <input type="text" className="b-Input w-100" placeholder="John@gmail.com" />
                        </div>
                    </form><br />
                    ...
                    <form >
                        ...
                        <div className="edit-margin">
                            ...
                            <input type="date" className="b-Input w-50" />
                        </div>
                        ...
                        <div className="edit-margin">
                            ...
                            <input type="number" className="b-Input" placeholder="0" />
                        </div>
                    </form>
                </div>

                <div className="row round-edit">
                    <div className="col-md-3"><img className="round-img" src="https://images.squarespace-cdn.com/content/v1/5a05c910017db256055decc2/629bbf1c-f877-45fd-860a-c33fbabac21c/Bigstock_+103020313+-+Luxury+At+33K+Feet.jpg?format=500w" alt="" /></div>
                    <div className="col-md-3"><img className="round-img" src="https://images.squarespace-cdn.com/content/v1/5a05c910017db256055decc2/1d112a62-9ee1-4c19-a86a-ef7b517e1cd1/Private%2BJet%2BMembership.jpeg?format=750w" alt="" /></div>
